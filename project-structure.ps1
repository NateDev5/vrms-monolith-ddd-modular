...
# ==========================================================
# VRMS Scaffolder (PowerShell) - RUN FROM PROJECT ROOT
...
$base = "src/main/java/com/nate/vrms2430884"

function RemoveDefaultVrmsApplicationIfExists() {
    $defaultPath = Join-Path $base "VrmsApplication.java"
    ...
    if (Test-Path $defaultPath) {
        ...
        $looksDefault =
            ($content -match 'package\s+com\.nate\.vrms2430884\s*;') -and
            ($content -match 'class\s+VrmsApplication') -and
            ($content -match '@SpringBootApplication') -and
            ($content -match 'SpringApplication\.run\(VrmsApplication\.class')

        if ($looksDefault) {
            Remove-Item $defaultPath -Force
            Write-Host "🧹 Removed default VrmsApplication.java at: $defaultPath"
        } else {
...
# app + shared
# ==========================================================
RemoveDefaultVrmsApplicationIfExists

WriteFile "$base/app/VrmsApplication.java" @"
package com.nate.vrms2430884.app;
...
package com.nate.vrms2430884.shared.config;
...
package com.nate.vrms2430884.shared.web;
...
package com.nate.vrms2430884.modules.cars.application.port.out;
...
package com.nate.vrms2430884.modules.cars.application.service;
...
package com.nate.vrms2430884.modules.cars.application.exception;
...
package com.nate.vrms2430884.modules.cars.infrastructure.persistence;
...
package com.nate.vrms2430884.modules.cars.api;
...
package com.nate.vrms2430884.modules.cars.api.mapper;
...
package com.nate.vrms2430884.modules.cars.api.dto;
...
package com.nate.vrms2430884.modules.owners.domain.model;
...
package com.nate.vrms2430884.modules.owners.domain.exception;
...
package com.nate.vrms2430884.modules.owners.application.port.out;
...
package com.nate.vrms2430884.modules.owners.application.service;
...
package com.nate.vrms2430884.modules.owners.application.exception;
...
package com.nate.vrms2430884.modules.owners.infrastructure.persistence;
...
package com.nate.vrms2430884.modules.owners.api;
...
package com.nate.vrms2430884.modules.owners.api.mapper;
...
package com.nate.vrms2430884.modules.agents.domain.exception;
...
package com.nate.vrms2430884.modules.agents.application.port.out;
...
package com.nate.vrms2430884.modules.agents.application.exception;
...
package com.nate.vrms2430884.modules.agents.infrastructure.persistence;
...
package com.nate.vrms2430884.modules.agents.api;
...
package com.nate.vrms2430884.modules.agents.api.mapper;
...
package com.nate.vrms2430884.modules.registration.domain.model;
...
package com.nate.vrms2430884.modules.registration.application.exception;
...
package com.nate.vrms2430884.modules.registration.infrastructure.persistence;
...
package com.nate.vrms2430884.modules.registration.api;
...
Write-Host ""
Write-Host "✅ VRMS project structure generated successfully"
Write-Host ""
